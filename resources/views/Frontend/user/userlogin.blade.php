...
<head>
    <meta charset="utf-8">
    <title>VIE EMSI - Login</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="VIE EMSI Login" name="keywords">
    <meta content="VIE EMSI Student Portal Login" name="description">
        ...
        <div class="container">
            <div class="col-left">
                <div class="login-text">
                    <h2>VIE EMSI</h2>
                    <p>
                        Fais partie de la communauté VIE EMSI et reste connecté à la vie de l’école.
